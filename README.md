...
The DTDL-based RealEstateCore ontology accelerates developers from the “blank page” and facilitates business-to-business integrations between vendors in a smart building. Since the DTDL-based ontology is open sourced, developers can easily annotate existing models while contributing their own domain expertise. [More about Real Estate Core](Partners/README.md#more-about-real-estate-core), and [more about Willow](Partners/README.md##more-about-willow).
