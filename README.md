...
- **Capability** interfaces are based on the BMS notion of Points (as represented in Brick Schema or Haystack) or Affordances, as represented in [Web of Things](https://www.w3.org/WoT/). Subclasses of Capability denote specific sensorsing or actuation capabilities that can be assigned to Spaces, Assets, etc.
