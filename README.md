...
The original RealEstateCore ontology is represented using the W3C Web Ontology Language (OWL) and it can be visualized [here](http://www.visualdataweb.de/webvowl/#iri=https://w3id.org/rec/full/3.3/). It has been converted into the DTDL syntax used in this repository using our universal [OWL2DTDL](OWL2DTDL/README.md) tool.
